 ...
 * the data of the file, all the lines except the first one, next we use the hashcode method of the String class to
 ...
 */
public class TXTtoCSVConverterFa1 {
        ...
        for (String line : txtFileData) {
            ...
            if (isAreaLine(line)) {
                ...
                if (isMainLine(line)) {
                    ...
                    TXTtoCSVConverterFa1.area = area;
    ...
    private static void getDataFromMainLine(String mainLine) {
        ...
        TXTtoCSVConverterFa1.number = number;
        ...
        TXTtoCSVConverterFa1.altaDate = altaDate;
        ...
        TXTtoCSVConverterFa1.updateDate = updateDate;
    }
    ...
    private static String checkData(String data) {
        try {
            ...
            System.out.println("Warning, data checking fails");
            return "NoDataThisWasGeneratedByAnError";
        }
